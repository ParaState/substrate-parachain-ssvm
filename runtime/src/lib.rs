...
impl WeightToFeePolynomial for WeightToFee {
	...
	fn polynomial() -> WeightToFeeCoefficients<Self::Balance> {
		// in Rococo, extrinsic base weight (smallest non-zero weight) is mapped to 1 GIGAWEI:
		// in our template, we map to 1/10 of that, or 1/10 GIGAWEI
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("parastate-parachain"),
	impl_name: create_runtime_str!("parastate-parachain"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 0,
...
pub const EXISTENTIAL_DEPOSIT: Balance = currency::GIGAWEI;
...
/// Use this as call filter for balances pallet.
...
impl pallet_authorship::Config for Runtime {
	...
	type FilterUncle = ();
	type EventHandler = (CollatorSelection, RewardManager);
}
...
parameter_types! {
	...
	pub const TransactionByteFee: Balance = 10 * currency::MEGAWEI;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		// Sudo
		Sudo: pallet_sudo::{Pallet, Call, Storage, Event<T>, Config<T>} = 25,
